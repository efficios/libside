...
#define ARGPAR_REALLOC(_ptr, _type, _nmemb) ((_type *) xrealloc(_ptr, (_nmemb) * sizeof(_type)))

#define ARGPAR_CALLOC(_type, _nmemb) ((_type *) xcalloc((_nmemb), sizeof(_type)))
